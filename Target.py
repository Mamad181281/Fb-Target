...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mplz wait connecting internet'
        time.sleep(2)
        toolbar_width = 25
